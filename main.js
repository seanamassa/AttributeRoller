...
class Player {
    ...
    for (const key in this.attributes){
            ...
            results.sort(function(a, b){return a - b}); // numeric sort with compare funcion
...
player02.printPlayer();
    ...
    //Fischer-Yates algorith for randomly sorting an array
    // adpapted to JS and reconfigured to return a new non mutated array
